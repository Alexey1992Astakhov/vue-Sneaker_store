<template>
  <footer class="bg-gray-500 text-white py-12 mt-10">
    <div class="container mx-auto px-4">
      <div class="flex flex-wrap justify-between">
        <div class="w-full md:w-1/3 mb-6 md:mb-0">
          <h3 class="text-xl font-semibold mb-2">О нас</h3>
          <p class="text-sm">
            Мы компания, стремящиеся дать кроссовки <br />
            которые люди будут с удовольствием носить.
          </p>
        </div>
        <div class="w-full md:w-1/3 mb-6 md:mb-0">
        ...
        <div class="w-full md:w-1/3">
          <h3 class="text-xl font-semibold mb-2">Следите за нами</h3>
          <div class="flex space-x-4">
            ...
            <a href="https://x.com/?lang=ru" class="text-gray-400 hover:text-white">
      ...
      <div class="text-center mt-8">
        <p class="text-sm text-gray-500">&copy; 2024 Company. Все права защищены.</p>
      </div>
    </div>
  </footer>
</template>
